...
reference the [Changing the secinit Directory](#aco-init) section below.
...
reference the [Setting Keys for Encryption Without Key Gen Command](#aco-gen)
...
[Selecting Attributes to Encrypt](#aco-add) section. To ensure certain attributes are
**not encrypted** reference the [Selecting Attributes to Exclude from Encryption](#aco-rmv)
...
the [python re documentation](<https://docs.python.org/3.7/library/re.html>)
